...
% Modification by Giorgos Bouritsas 2018 : include the word_ids file as well.
% [docNode,checkpassedflag]=moviescript2xml(fullfile('sources/American Beauty.txt','sources/American Beauty_word_ids.mat');
% see align_subs_script_all.
...
% Input: parsed xml movie script (see above); subtitles in .srt text format
